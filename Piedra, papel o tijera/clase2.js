...
function pedirJugada() {
    ...
    } while (isNaN(eleccion) || eleccion < 1 || eleccion > 3 || eleccion.isEmpty)
...
let finPartida = (resultadoDePartida) =>{

    console.log(resultadoDePartida);
    alert(resultadoDePartida);
    if(resultadoDePartida== 'Una lástima, perdiste.'){
        alert("Seguí participando, la próxima seguro ganás.")
    }
    return resultadoDePartida;
}
console.log(finPartida(resultadoDePartida));
/* -------------------------------------------------------------------------- */
